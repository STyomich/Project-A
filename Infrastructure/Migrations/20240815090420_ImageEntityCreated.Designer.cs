...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240815090420_ImageEntityCreated")]
    partial class ImageEntityCreated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.Anime", b =>
                {
                    ...
                    b.Property<string>("TitleInRussian")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TitleInUkrainian")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Domain.Entities.VoiceCast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Domain.Entities.VoiceCastPin", b =>
                {
                    b.Property<Guid>("EpisodeId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("VoiceCastId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("Link")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("EpisodeId", "VoiceCastId");

                    b.HasIndex("VoiceCastId");

                    b.ToTable("VoiceCastPins");
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.Anime", b =>
                {
                    b.HasOne("Core.Domain.Image", "Picture")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Domain.Entities.VoiceCastPin", b =>
                {
                    b.HasOne("Core.Domain.Entities.Episode", "Episode")
                        .WithMany("VoiceCastPins")
                        .HasForeignKey("EpisodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Domain.Entities.VoiceCast", "VoiceCast")
                        .WithMany("VoiceCastPins")
                        .HasForeignKey("VoiceCastId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Episode");

                    b.Navigation("VoiceCast");
                });

            modelBuilder.Entity("Core.Domain.IdentityEntities.ApplicationUser", b =>
                {
                    b.HasOne("Core.Domain.Image", "Avatar")
                        .WithMany()
